...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://raw.githubusercontent.com/dopekid30/AutoScriptDebian10/main/Resources/Menu/ssrmu.sh"
...
Install_SSR
wget -O /usr/bin/ssr https://raw.githubusercontent.com/dopekid30/AutoScriptDebian10/main/Resources/Menu/ssrmu.sh && chmod +x /usr/bin/ssrmu
wget -O /usr/bin/addssr https://raw.githubusercontent.com/dopekid30/AutoScriptDebian10/main/Resources/Menu/addssr.sh && chmod +x /usr/bin/addssr
wget -O /usr/bin/delssr https://raw.githubusercontent.com/dopekid30/AutoScriptDebian10/main/Resources/Menu/delssr.sh && chmod +x /usr/bin/delssr
wget -O /usr/bin/xp-ssr https://raw.githubusercontent.com/dopekid30/AutoScriptDebian10/main/Resources/Menu/xp-ssr.sh && chmod +x /usr/bin/xp-ssr
wget -O /usr/bin/renewssr https://raw.githubusercontent.com/dopekid30/AutoScriptDebian10/main/Resources/Menu/renewssr.sh && chmod +x /usr/bin/renewssr
